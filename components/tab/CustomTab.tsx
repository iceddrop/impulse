    ...
    return (
        <View style={[tw`absolute inset-x-0 bottom-0 bg-white p-4`, {backgroundColor : darkMode ? "#374151" : "whitesmoke"}]}>
            <View style={tw`flex flex-row justify-around`}>
                ...
                <TouchableOpacity onPress={() => {setActiveTab("Savings") ; router.push("/Savings")}} style={tw`flex justify-center items-center`}><MaterialIcons name="savings" size={24} color={activeTab === "Savings" ? "green" : "black"} /><Text style={[activeTab === "Savings" ? tw`text-center text-green-800` : tw`text-center text-green-800`, {fontFamily: "PoppinsRegular"}]}>Savings</Text></TouchableOpacity>
